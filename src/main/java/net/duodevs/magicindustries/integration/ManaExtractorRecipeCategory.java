...
public class ManaExtractorRecipeCategory implements IRecipeCategory<ManaExtractorRecipe> {
   public static final Identifier UID = Identifier.fromNamespaceAndPath("magicindustries", "gem_infusing");
   public static final Identifier TEXTURE = Identifier.fromNamespaceAndPath("magicindustries", "textures/gui/mana_extractor_gui.png");
