...
public class ManaExtractorMenu extends AbstractContainerMenu {
   ...
   public ManaExtractorMenu(int id, Inventory inv, RegistryFriendlyByteBuf extraData) {
   ...
   public ManaExtractorMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
      ...
      this.addSlot(new SlotItemHandler(this.blockEntity.getInternalItemHandler(), 0, 25, 31));
      this.addSlot(new SlotItemHandler(this.blockEntity.getInternalItemHandler(), 1, 130, 31));
