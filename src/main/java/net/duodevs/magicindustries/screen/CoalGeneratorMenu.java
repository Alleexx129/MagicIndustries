...
public class CoalGeneratorMenu extends AbstractContainerMenu {
   ...
   public CoalGeneratorMenu(int id, Inventory inv, RegistryFriendlyByteBuf extraData) {
   ...
   public CoalGeneratorMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
      ...
      this.addSlot(new SlotItemHandler(this.blockEntity.getInternalItemHandler(), 0, 26, 36));
