...
public class EnergyInfoArea2 extends InfoArea {
   private final IEnergyStorage energy;

   public EnergyInfoArea2(int xMin, int yMin, IEnergyStorage energy) {
      this(xMin, yMin, energy, 24, 55);
   }

   public EnergyInfoArea2(int xMin, int yMin, IEnergyStorage energy, int width, int height) {
