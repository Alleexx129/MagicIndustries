...
public class ManaExtractorScreen extends AbstractContainerScreen<ManaExtractorMenu> {
   private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath("magicindustries", "textures/gui/mana_extractor_gui.png");
   private HelpInfoArea helpInfoArea;
   private FluidTankRenderer renderer;
   private static final Identifier ARROW_TEXTURE = Identifier.fromNamespaceAndPath("magicindustries", "textures/gui/mana_extractor_arrow.png");
   ...
   protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
      ...
      this.renderer.render(guiGraphics, x + 155, y + 11, ((ManaExtractorMenu)this.menu).getFluidStack());
      this.renderer.render(guiGraphics, x + 104, y + 11, ((ManaExtractorMenu)this.menu).getFluidStackMana());
   }
   ...
   protected void renderTooltip(GuiGraphics guiGraphics, int mouseX, int mouseY) {
      ...
      if (this.isMouseOverHelpArea(mouseX, mouseY)) {
         guiGraphics.setTooltipForNextFrame(this.font, this.helpInfoArea.getTooltips(), Optional.empty(), mouseX, mouseY);
      }
   ...
   private void renderProgressArrow(GuiGraphics guiGraphics, int x, int y) {
      guiGraphics.blit(RenderPipelines.GUI_TEXTURED, ARROW_TEXTURE, x + 45, y + 30, 0, 0, ((ManaExtractorMenu)this.menu).getScaledProgress(), 20, 256, 256);
   }
}
